...
function highlightSubtext2(mainText: string, subtext: string, customClass: string, caseSensitive: boolean): string {
    let indices: number[] = [];
 ...
 */
function greet(name: string, age: number = 52): void {
    console.info(`Hello ${name}, Age is ${age}`)
}


function greet3(age: number | undefined = 22, name: string): void {
    console.info(`Hello ${name}, Age is ${age}`)
}
...
function aaaa(name: string): string

function aaaa(name: number): number

function aaaa(name: unknown): unknown {
