...
let arrays: string[] = ["Red", "Green", "Blue", "Gray"]
let arrNum: Array < number > = [12, 45, 78, 102, 489]
let values: (string | number)[] = ['Apple', 2, 'Orange', 3, 4, 'Banana'];
let values2: Array <string | number> = ['Apple', 2, 'Orange', 3, 4, 'Banana'];
console.log(values2.length)
let arrDate: dayjs.Dayjs[] = [
...
arrDate.sort((a: dayjs.Dayjs, b: dayjs.Dayjs) => {
...
let dd5:string[]=['One', 'Two', 'Three', 'Two']
let dd6:string[] =['Four', 'Five', 'Six']
...
let dd7:string[]=['One', 'Two', 'Three', 'Two', 'Ten']
...
const fruits5: string[] = ['Apple', 'banana', 'cherry', 'date', 'grape', 'peach'];
...
const arr5 = [...new Array<string>(3)].fill('Hello');
