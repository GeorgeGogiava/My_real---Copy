...
const n:number[] =[7,12, 8.9, -98, 93, 0.12]
...
const float:number =2.369
const str:string='sdfgsdfgsdf'
const c = undefined
const f=(x:number):number =>{return x *10}
const nu =null
const o:object ={name:'gss', age:45}
const names:string[] =['dfdf', 'sgfgfg']
...
let y:string='3.65'; let yInt="1564"
let y2:number=parseFloat(y)
let y3:number=parseInt(yInt)
let y4:number=parseInt(y)
